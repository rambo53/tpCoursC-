...
namespace chats.Models
{
    public class Pizza
    {
        ...
        public List<Pizza> PizzasDisponibles { get; set; } = new List<Pizza>();
    ...
    public static List<Ingredient> IngredientsDisponibles => new List<Ingredient>
        ...
        {
            newPizza.Id = PizzasDisponibles.Count + 1;
            PizzasDisponibles.Add(newPizza);
        }

        public void updatePizza(Pizza newPizza)
        {
            var pizzToDelete = getPizzaById(newPizza.Id);
            PizzasDisponibles.Remove(pizzToDelete);
            PizzasDisponibles.Add(newPizza);
        }

        public static Dictionary<string, object> getIngredientPate()
        {
            Dictionary<string, object> dict = new Dictionary<string, object>();
            dict.Add("Ingredients", IngredientsDisponibles);
            dict.Add("Pates", PatesDisponibles);
        ...
        {
            return PizzasDisponibles.FirstOrDefault(p => p.Id == id);
        }
